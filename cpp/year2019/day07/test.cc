...
TEST(Year2019Day07, Part1Example2) {
  std::ifstream input("cpp/year2019/day07/testdata/p1ex2");
...
TEST(Year2019Day07, Part1Example3) {
  std::ifstream input("cpp/year2019/day07/testdata/p1ex3");
...
TEST(Year2019Day07, Part2Example1) {
  std::ifstream input("cpp/year2019/day07/testdata/p2ex1");
...
TEST(Year2019Day07, Part2Example2) {
  std::ifstream input("cpp/year2019/day07/testdata/p2ex2");
