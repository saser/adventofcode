...
TEST(Year2019Day18, Part1Example1) {
  std::ifstream input("cpp/year2019/day18/testdata/p1ex1");
  std::string output = "8";
...
TEST(Year2019Day18, Part1Example2) {
  std::ifstream input("cpp/year2019/day18/testdata/p1ex2");
...
TEST(Year2019Day18, Part1Example3) {
  std::ifstream input("cpp/year2019/day18/testdata/p1ex3");
...
TEST(Year2019Day18, Part1Example4) {
  std::ifstream input("cpp/year2019/day18/testdata/p1ex4");
...
TEST(Year2019Day18, Part1Example5) {
  std::ifstream input("cpp/year2019/day18/testdata/p1ex5");
...
TEST(Year2019Day18, Part2Example1) {
  std::ifstream input("cpp/year2019/day18/testdata/p2ex1");
  std::string output = "8";
...
TEST(Year2019Day18, Part2Example2) {
  std::ifstream input("cpp/year2019/day18/testdata/p2ex2");
...
TEST(Year2019Day18, Part2Example3) {
  std::ifstream input("cpp/year2019/day18/testdata/p2ex3");
...
TEST(Year2019Day18, Part2Example4) {
  std::ifstream input("cpp/year2019/day18/testdata/p2ex4");
