...
mod tests {
    ...
    mod part1 {
        ...
        test!(example, file "testdata/day02/p1ex", "12", part1);
        test!(actual, file "../../../inputs/2018/02", "5880", part1);
    }

    mod part2 {
        use super::*;

        test!(example, file "testdata/day02/p2ex", "fgij", part2);
        test!(actual, file "../../../inputs/2018/02", "tiwcdpbseqhxryfmgkvjujvza", part2);
    }
}
