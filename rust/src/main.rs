...
fn imain() -> i32 {
    ...
    let solution: Result<aoc::Solution, String> = match year {
        ...
        2018 => match day {
            ...
            5 => match part {
                1 => Ok(aoc::year2018::day05::part1),
                2 => Ok(aoc::year2018::day05::part2),
                _ => unreachable!(),
            },
            6 => match part {
                1 => Ok(aoc::year2018::day06::part1),
                2 => Ok(aoc::year2018::day06::part2),
                _ => unreachable!(),
            },
            7 => match part {
                1 => Ok(aoc::year2018::day07::part1),
                2 => Ok(aoc::year2018::day07::part2),
                _ => unreachable!(),
            },
            8 => match part {
                1 => Ok(aoc::year2018::day08::part1),
                2 => Ok(aoc::year2018::day08::part2),
                _ => unreachable!(),
            },
            9 => match part {
                1 => Ok(aoc::year2018::day09::part1),
                2 => Ok(aoc::year2018::day09::part2),
                _ => unreachable!(),
            },
            10 => match part {
                1 => Ok(aoc::year2018::day10::part1),
                2 => Ok(aoc::year2018::day10::part2),
                _ => unreachable!(),
            },
            11 => match part {
                1 => Ok(aoc::year2018::day11::part1),
                2 => Ok(aoc::year2018::day11::part2),
                _ => unreachable!(),
            },
            12 => match part {
                1 => Ok(aoc::year2018::day12::part1),
                2 => Ok(aoc::year2018::day12::part2),
                _ => unreachable!(),
            },
            13 => match part {
                1 => Ok(aoc::year2018::day13::part1),
                2 => Ok(aoc::year2018::day13::part2),
                _ => unreachable!(),
            },
            14 => match part {
                1 => Ok(aoc::year2018::day14::part1),
                2 => Ok(aoc::year2018::day14::part2),
                _ => unreachable!(),
            },
            15 => match part {
                1 => Ok(aoc::year2018::day15::part1),
                2 => Ok(aoc::year2018::day15::part2),
                _ => unreachable!(),
            },
            16 => match part {
                1 => Ok(aoc::year2018::day16::part1),
                2 => Ok(aoc::year2018::day16::part2),
                _ => unreachable!(),
            },
            17 => match part {
                1 => Ok(aoc::year2018::day17::part1),
                2 => Ok(aoc::year2018::day17::part2),
                _ => unreachable!(),
            },
            18 => match part {
                1 => Ok(aoc::year2018::day18::part1),
                2 => Ok(aoc::year2018::day18::part2),
                _ => unreachable!(),
            },
            19 => match part {
                1 => Ok(aoc::year2018::day19::part1),
                2 => Ok(aoc::year2018::day19::part2),
                _ => unreachable!(),
            },
            20 => match part {
                1 => Ok(aoc::year2018::day20::part1),
                2 => Ok(aoc::year2018::day20::part2),
                _ => unreachable!(),
            },
